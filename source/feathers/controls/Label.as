...
public class Label extends DisplayObjectContainer
{
	...
	private var mEmbedFonted:Boolean = Fontter.embedFonts;
...
//		autoSize = TextFieldAutoSize.NONE;
	...
	{
		if(_textFormat)textField.defaultTextFormat = _textFormat;
		if(this.mEmbedFonted)
		{
	...
	private function createRenderedContents():void
	{
		...
		//trace("Label:createRenderedContents ",Starling.context.driverInfo);	
...
/*	public override function get height():Number
	...
	private function get hAlign():String { return mHAlign; }
	...
	private function get vAlign():String { return mVAlign; }
	 ...
	 * */
	public function get embedFonted():Boolean { return mEmbedFonted; }
	public function set embedFonted(value:Boolean):void{ mEmbedFonted = value;}
